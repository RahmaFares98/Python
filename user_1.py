...
Rahma.make_deposit(200),Rahma.make_deposit(700),Rahma.make_deposit(1000),Rahma.make_withdrawal(543),Rahma.display_user()
# Second user: 2 deposits and 2 withdrawals, then display balance
Basel.make_deposit(300),Basel.make_deposit(230),Basel.make_withdrawal(300),Basel.make_withdrawal(300),Basel.display_user()
...
Rahma.transfer_money(Husam ,500),Rahma.display_user(),Husam.display_user()